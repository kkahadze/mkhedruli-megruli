...
export const translations = {
  en: {
    ...
    updatesDescription: 'Meaningful improvements to Mkhedruli design, translation quality, coverage, and reliability.',
    updatesBack: 'Back to translator',
    updatesAugust2026: 'August 2026',
    updatesVisualDesign: 'Refreshed the translator with a cleaner, more modern design while preserving its familiar layout.',
    updatesLanguagePanels: 'Refined language controls and translation panels with clearer spacing and typography.',
    updatesNavigationAndSettings: 'Updated navigation, settings, the updates page, and the footer with a consistent visual style.',
    updatesMobileLayout: 'Improved layouts and settings usability on smaller screens.',
  ...
  ka: {
    ...
    footerLastUpdated: 'ბოლოს განახლდა: 2026 წლის აგვისტო',
    updatesTitle: 'განახლებები',
    updatesDescription: 'Mkhedruli-ის დიზაინის, თარგმანის ხარისხის, დაფარვისა და საიმედოობის მნიშვნელოვანი გაუმჯობესებები.',
    updatesBack: 'მთარგმნელზე დაბრუნება',
    updatesAugust2026: '2026 წლის აგვისტო',
    updatesVisualDesign: 'მთარგმნელის დიზაინი უფრო სუფთა და თანამედროვე გახდა, ნაცნობი განლაგების შენარჩუნებით.',
    updatesLanguagePanels: 'ენის არჩევისა და თარგმანის პანელები გაუმჯობესდა: დაიხვეწა განლაგება და ტექსტის გაფორმება.',
    updatesNavigationAndSettings: 'ნავიგაცია, პარამეტრები, განახლებების გვერდი და ქვედა ნაწილი ერთიან ვიზუალურ სტილში განახლდა.',
    updatesMobileLayout: 'გაუმჯობესდა მობილური განლაგება და პარამეტრების გამოყენება მცირე ეკრანებზე.',
